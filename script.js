...
cinematicStyle.textContent = `
  ...
  .site-header,.section,.ticker,.site-footer{position:relative;background:rgba(3,9,22,.72)!important;color:#f4f7ff!important;border-color:#ffffff1c!important}
  .site-header{backdrop-filter:blur(18px)}
  .section-heading>p:last-child,.hero-text,.split-heading>p,.process-step p,.video-copy>p:not(.eyebrow),.map-copy>p:not(.eyebrow){color:#b9c6dc!important}
  .service-card{background:#0b1425cc!important;border-color:#ffffff20!important;color:#f4f7ff}.service-card p{color:#afbdd2}.work-section,.services-section,.process-section,.map-section{background:transparent!important}.map-section{background:#07152acc!important}.contact-section{background:linear-gradient(135deg,#d94f5f,#7136b8)!important}
  ...
  @media(max-width:700px){.earth-globe{width:78vw;top:47%;opacity:.22}.cinematic-space:after{width:100vw;height:100vw;left:0;top:25%}}
...
const space = document.createElement('div'); space.className = 'cinematic-space'; space.setAttribute('aria-hidden','true');
const earth = document.createElement('div'); earth.className = 'earth-globe'; earth.setAttribute('aria-hidden','true');
